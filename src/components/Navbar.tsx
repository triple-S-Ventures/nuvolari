...
const Navbar = () => {
  ...
  return (
    <nav className={cn(
      "fixed top-0 left-0 right-0 z-50 flex items-center justify-between py-3 px-6 transition-all duration-300", 
      isScrolled ? "bg-background/80 backdrop-blur-lg shadow-md" : "bg-transparent backdrop-blur-sm"
    )}>
      <div className="flex-1 flex items-center justify-start">
        <button className="flex items-center justify-center w-10 h-10 rounded-lg bg-secondary/50 backdrop-blur-sm text-primary hover:bg-secondary/70 transition-all duration-300 animate-fade-in">
