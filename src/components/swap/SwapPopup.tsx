...
const SwapPopup = ({ 
  ...
  // Debug popup visibility states
  useEffect(() => {
    console.log('POPUP VISIBILITY STATES:');
    console.log('- showConfirmation:', showConfirmation);
    console.log('- showSuccess:', showSuccess);
    console.log('- currentStep:', currentStep);
  }, [showConfirmation, showSuccess, currentStep]);
  ...
  const handleConfirm = () => {
    setIsLoading(true);
    console.log('Confirm button clicked, showing confirmation popup...');
    // Simulate API call
    setTimeout(() => {
      setIsLoading(false);
      setCurrentStep(2);
      setShowConfirmation(true);
      console.log('Confirmation popup should now be visible. showConfirmation:', true);
    }, 1000);
  };

  const handleExecute = () => {
    setIsLoading(true);
    console.log('Execute button clicked, will show success popup...');
    // Simulate API call
    setTimeout(() => {
      setIsLoading(false);
      setCurrentStep(3);
  ...
  const handleEdit = () => {
    setShowConfirmation(false);
    setCurrentStep(1);
    console.log('Edit button clicked, returning to first popup');
  };
  ...
  const handleGoToJournal = () => {
    ...
    console.log('Go to journal button clicked');
    onClose();
  };
  ...
  // Render the appropriate popup based on the current state
